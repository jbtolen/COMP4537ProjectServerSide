...
class MLController {
  ...
  // ✅ Setup CORS for both local + hosted
  setupCors() {
    const corsOptions = {
      origin: [
...
// Export an instance’s router so server.js can use it
module.exports = new MLController().getRouter();
